...
You can think about a regular (deterministic) function like a box. For example, for $f(x) = x^2$, *every time* you give the function the value 2, and it will give you back 4. However, random variables are random functions that map the sample space (different students) into the real line (test score values between 0 and 100). Each time you apply the function it gives you a different number.


## Discrete and continuous random variable

There are generally two types of random variables: _discrete_ and _continuous_.
