...
You are an educational researcher tasked by the principal of a local high school to determine whether or not a new afterschool pilot program is effective in improving students' Global History regents scores. The high school has secured the participation of 100 students who failed the exam once (out of 2,000), and you now turn to face your daunting task. 
...
You have a sample of 100 students, and must now randomly assign them into treatment and control groups. The treatment group will go through the new afterschool program, and the control group will receive normal tutoring. You will record their previous test scores as the pre-treatment test scores and their test scores after the program as the outcomes.


### What is simulation?
Wearing the _researcher_ hat, you cannot know what the post-program test scores of the students in the treatment group in the absence of the pilot program would be. However, as researchers, you shall use simulation to reproduce "a parallel universe" that imitates the actual events and gives you an insights of "what ifs". The simulation can generate as many new results as you need, and it represents the characterstics of the model you defined.
